...
- Définir service, valeur, client et fournisseur.
- Distinguer processus, fonction et rôle.
- Identifier propriétaire de processus et acteurs.
- Employer un vocabulaire commun au centre de services.

!!! tip "Façon simple de le comprendre"
    Ce module sert à passer de la notion « La gestion des services » à une méthode que l’on peut expliquer, appliquer, vérifier et dépanner.
...
#### Nom de processus Commerciaux Ressources
...
- Doit prendre connaissance de l’action et de son
...
- [Fiche de révision du module](../../revision/itil/module-02-la-gestion-des-services.md)

## Questions flash

1. Comment expliquer simplement « La gestion des services » à un collègue ?
