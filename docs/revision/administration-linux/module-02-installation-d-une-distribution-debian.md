...
1. Quels sont les concepts indispensables de « Installation d’une distribution Debian » ?
...
Pour approfondir : [cours complet](../../modules/05-administration-debian-gnu-linux/module-02-installation-d-une-distribution-debian.md).
