# Corrections — Module 04 — Transition des services
...
## M04 - S01 TP-Corrigé_Transition des services
...
#### Vérification disponibilité du matériel du stock 15 min

#### technicien

#### Parc

#### Création du bon de commande du matériel manquant 10 min
...
#### c. Vérifier l’identification du matériel
  ...
  - Imprimer les étiquettes d’inventaire si nécessaire

#### d. Mettre à jour le CMS

#### Sortie du stock du matériel 15 min

#### technicien

#### Parc

#### Vérification de l’identification du matériel 15 min

#### technicien

#### Parc

#### Impression des étiquettes d’identification et mise à jour CMS 5 min /
...
#### Installation d’un bureau 30 min

#### technicien

#### Parc

#### Installation d’un fauteuil 30 min

#### technicien

#### Parc

#### Création du bon de commande du mobilier manquant 10 min
...
#### b. Si le nombre de prises est insuffisant
  ...
  - Prévoir l'installation de nouvelles prises
...
#### Création du bon de commande prise les prises manquantes 10 min

#### technicien

#### Parc

#### Installation des nouvelles prises électriques 10 jours Entreprise
...
#### connexion des prises réseau au switch 40 min
...
#### Installation des nouvelles prises réseau 10 jours Entreprise
...
#### Paramétrage des ports du switch 20 min
...
#### Création compte messagerie Microsoft 365 10 min
...
#### Création du compte utilisateur dans GLPI 10 min
...
#### Création du N° téléphone 10 min
...
#### a. Vérifier le fonctionnement téléphone IP et de son câble RJ45
  ...
  - Connecter le téléphone IP sur le réseau (câble RJ45 sur le port 1 du switch du
...
#### c. Tester le clavier et la souris
  ...
  - Connecter les deux périphériques au dock
...
Configuration et vérification du fonctionnement du matériel 3 heures 1 technicien
...
#### b. Installer le dock
  ...
  - Brancher le dock sur le switch du téléphone IP (port 2)

- Câble RJ45 de 2m

  - Brancher électriquement le dock
...
#### e. Installer l’ordinateur portable
  ...
  - Ouvrer la session avec un compte technicien du domaine
...
- Vérifier l’application des GPO du domaine pour les
...
#### Livraison et configuration d'un ordi portable commercial 2
